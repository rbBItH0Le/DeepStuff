...
train_data_generator=traind.flow_from_directory('cats-v-dogs/training/',target_size=(150,150),batch_size=20,class_mode='binary')
valid_data_generator=testd.flow_from_directory('cats-v-dogs/testing/',target_size=(150,150),batch_size=20,class_mode='binary')
